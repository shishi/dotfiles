...
return packer.startup(function(use)
	...
	use({
		...
		config = function()
			...
			-- 	silent = true,
			-- }
			vim.keymap.set('n', '<Leader>e', vim.diagnostic.open_float, { noremap = true, silent = true, desc = 'diagnose open_float'})
			vim.keymap.set('n', '<Leader>[', vim.diagnostic.goto_prev, { noremap = true, silent = true, desc = 'diagnose goto_prev'})
			vim.keymap.set('n', '<Leader>]', vim.diagnostic.goto_next, { noremap = true, silent = true, desc = 'diagnose goto_next'})
			...
			local on_attach = function(client, bufnr)
				...
				-- 	buffer = bufnr,
				-- }
				vim.keymap.set('n', 'gD', vim.lsp.buf.declaration, {noremap = true, silent = true, buffer = bufnr, desc = 'vim.lsp delaration'})
				vim.keymap.set('n', 'gd', vim.lsp.buf.definition, {noremap = true, silent = true, buffer = bufnr, desc = 'vim.lsp definition'})
				vim.keymap.set('n', 'K', vim.lsp.buf.hover, {noremap = true, silent = true, buffer = bufnr, desc = 'vim.lsp hover'})
				vim.keymap.set('n', 'gi', vim.lsp.buf.implementation, {noremap = true, silent = true, buffer = bufnr, desc = 'vim.lsp implementation'})
				vim.keymap.set('n', '<C-k>', vim.lsp.buf.signature_help, {noremap = true, silent = true, buffer = bufnr, desc = 'vim.lsp signature_help'})
				vim.keymap.set('n', '<Leader>wa', vim.lsp.buf.add_workspace_folder, {noremap = true, silent = true, buffer = bufnr, desc = 'vim.lsp add_workspace_folder'})
				vim.keymap.set('n', '<Leader>wr', vim.lsp.buf.remove_workspace_folder, {noremap = true, silent = true, buffer = bufnr, desc = 'vim.lsp remove_workspace_folder'})
				vim.keymap.set('n', '<Leader>wl', function()
          print(vim.inspect(vim.lsp.buf.list_workspace_folders()))
        end, {noremap = true, silent = true, buffer = bufnr, desc = 'vim.lsp list_workspace_folders'
          })
				vim.keymap.set('n', '<Leader>D', vim.lsp.buf.type_definition, {noremap = true, silent = true, buffer = bufnr, desc = 'vim.lsp type_definition'})
				vim.keymap.set('n', '<Leader>rn', vim.lsp.buf.rename, {noremap = true, silent = true, buffer = bufnr, desc = 'vim.lsp rename'})
				vim.keymap.set('n', '<Leader>ca', vim.lsp.buf.code_action, {noremap = true, silent = true, buffer = bufnr, desc = 'vim.lsp code_action'})
				vim.keymap.set('n', 'gr', vim.lsp.buf.references, {noremap = true, silent = true, buffer = bufnr, desc = 'vim.lsp references'})
				vim.keymap.set('n', '<Leader>gf', vim.lsp.buf.formatting, {noremap = true, silent = true, buffer = bufnr, desc = 'vim.lsp formatting'})
